...
<head>
  ...
  <title>Login &mdash; Go Canteen</title>
      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Go Canteen</span></h4>
            <p class="text-muted">Sebelum kamu menggunakan aplikasi, kamu harus login atau daftar sebagai pengguna aplikasi untuk masuk.</p>
            <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
              ...
              <div class="mt-5 text-center">
                Tidak memiliki akun? <a href="{{ url('register') }}">Daftar sekarang</a>
              </div>
            </form>

            <div class="text-center mt-5 text-small">
              Copyright &copy; Cybersoft. Made with 💙 by Group 5
              <div class="mt-2">
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="{{ asset('template/img/unsplash/login-bg.jpg') }}">
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">Go Canteen</h1>
                <h5 class="font-weight-normal text-muted-transparent">Development by Cybersoft &mdash; SMK Negeri 10 Jakarta</h5>
              </div>
